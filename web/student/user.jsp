                                    ...
                                    <%
                                        ...
                                        <div id="printableArea">
                                         ...
                                         <%con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sis","root","");
                                            ...
                                            rs = st.executeQuery("SELECT * FROM payment WHERE email='"+a+"'");
                                          //  while(rs.next()){
                                            rs.last();
                                             %>
                                             <tr style="background-color:red"><td> Paid for:</td> <td> <%=rs.getString("payment") %> </td></tr><% //} %>
                                        ...
                                        <br> <br>   
                                        <input type="button" class="btn btn-primary active" onclick="printDiv('printableArea')" value="Print Id.Card" />          
