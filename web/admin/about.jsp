...
<style>
    ...
    <body>
     ...
     <div class="form-group">
        ...
        <h2> <marquee>Hello Administrator . Welcome to the About Editorial Blog . </marquee></h2>
 <h2> <label for="comment">Write :</label></h2>
...
<%
             ...
             <a href="user.jsp" class="btn btn-info pull-left" role="button">&nbsp&nbsp&nbsp Back &nbsp&nbsp&nbsp</a> &nbsp&nbsp&nbsp&nbsp
