...
<html>
    ...
    <body>
        ...
        String path="C:/Users/SHREYASKARNATH/Documents/NetBeansProjects/Registration/Registration/web/admin/image";
        %>
        <%
       ...
       // out.println(type);
        ...
        disFact.setRepository(new File("C:/Users/SHREYASKARNATH/Documents/NetBeansProjects/Registration/Registration/web/admin/image"));
