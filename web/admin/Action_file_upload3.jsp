...
<html>
    <head>
        ...
        String path="C:/Users/SHREYASKARNATH/Documents/NetBeansProjects/Registration/Registration/web/admin/slide";
        %>
        <%
        ...
        disFact.setRepository(new File("C:/Users/SHREYASKARNATH/Documents/NetBeansProjects/Registration/Registration/web/admin/slide"));
            ...
            try
                {
                    ...
                    String query="insert into photo values('"+fname+"')";
